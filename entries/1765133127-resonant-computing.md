...
At the same time, though, we have to recon with the fact that for 20+ years, people have known that software engineering is a high-paying job, and one with opportunities for getting rich by starting a startup (however long the odds may actually be). I'm not convinced that "most of us" in the tech industry got here because of a desire to improve the world — money and class seem like a much more present motivators for a majority of the tech industry. While the "logic if hyper-scale" may have swindled a handful of gullible bright-eyed new grads, I think it's far more common that people go into those environments because they understand that that's where the money is.
